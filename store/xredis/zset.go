...
func (c *Client) ZInterWithScores(ctx context.Context, key string, keys ...string) (map[string]float64, error) {
...
// 返回值：
// fromKey: 结果来自那个 key
func (c *Client) ZMPop(ctx context.Context, key string, keys []string, min bool, count int) (fromKey string, members map[string]float64, err error) {
	...
	members, err = resp3.ToMapFloat64(arr[1], err)
...
func (c *Client) ZPopMax(ctx context.Context, key string, count int) (map[string]float64, error) {
	args := make([]any, 2, 4)
	args[0] = "ZPOPMAX"
	args[1] = key
	if count > 0 {
...
func (c *Client) ZPopMin(ctx context.Context, key string, count int) (map[string]float64, error) {
	args := make([]any, 2, 4)
	args[0] = "ZPOPMIN"
	args[1] = key
	if count > 0 {
...
func (c *Client) ZRandMemberWithScores(ctx context.Context, key string, count int) (map[string]float64, error) {
...
func (c *Client) ZRangeWithScore(ctx context.Context, key string, start int64, stop int64) (map[string]float64, error) {
	cmd := resp3.NewRequest(resp3.DataTypeArray, "ZRANGE", key, start, stop, "WITHSCORES")
	resp := c.do(ctx, cmd)
	return resp3.ToMapFloat64(resp.result, resp.err)
}

func (c *Client) ZRangeRevWithScore(ctx context.Context, key string, start int64, stop int64) (map[string]float64, error) {
	cmd := resp3.NewRequest(resp3.DataTypeArray, "ZRANGE", key, start, stop, "REV", "WITHSCORES")
	resp := c.do(ctx, cmd)
	return resp3.ToMapFloat64(resp.result, resp.err)
}

func (c *Client) ZRangeByScoreWithScore(ctx context.Context, key string, start int64, stop int64) (map[string]float64, error) {
	cmd := resp3.NewRequest(resp3.DataTypeArray, "ZRANGE", key, start, stop, "BYSCORE", "WITHSCORES")
	resp := c.do(ctx, cmd)
	return resp3.ToMapFloat64(resp.result, resp.err)
}

func (c *Client) ZRangeRevByScoreWithScore(ctx context.Context, key string, start int64, stop int64) (map[string]float64, error) {
	cmd := resp3.NewRequest(resp3.DataTypeArray, "ZRANGE", key, start, stop, "BYSCORE", "REV", "WITHSCORES")
	resp := c.do(ctx, cmd)
	return resp3.ToMapFloat64(resp.result, resp.err)
}

func (c *Client) ZRangeByLexWithScore(ctx context.Context, key string, start int64, stop int64) (map[string]float64, error) {
	cmd := resp3.NewRequest(resp3.DataTypeArray, "ZRANGE", key, start, stop, "BYLEX", "WITHSCORES")
	resp := c.do(ctx, cmd)
	return resp3.ToMapFloat64(resp.result, resp.err)
}

func (c *Client) ZRangeRevByLexWithScore(ctx context.Context, key string, start int64, stop int64) (map[string]float64, error) {
