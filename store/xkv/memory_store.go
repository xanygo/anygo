...
func (m *memList) LPush(ctx context.Context, val string) error {
	return m.withSliceLocked(func(list []string) ([]string, bool) {
		return slices.Insert(list, 0, val), true
	})
}

func (m *memList) RPush(ctx context.Context, val string) error {
	return m.withSliceLocked(func(list []string) ([]string, bool) {
		return append(list, val), true
	})
}
...
func (m *memHash) HDel(ctx context.Context, field string) error {
	return m.withMapLocked(func(m map[string]string) (map[string]string, bool) {
		if len(m) == 0 {
			return m, false
		}
...
func (m *memSet) SAdd(ctx context.Context, val string) error {
	return m.withSliceLocked(func(list []string) ([]string, bool) {
...
func (m *memSet) SRem(ctx context.Context, val string) error {
	return m.withSliceLocked(func(list []string) ([]string, bool) {
		if !slices.Contains(list, val) {
			return list, false
		}
		return xslice.DeleteValue(list, val), true
	})
}
...
func (m *memZSet) ZRem(ctx context.Context, member string) error {
