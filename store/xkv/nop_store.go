...
func (n nopList[V]) LPush(ctx context.Context, val V) error {
	return nil
}

func (n nopList[V]) RPush(ctx context.Context, val V) error {
	return nil
}
...
func (n nopHash[V]) HDel(ctx context.Context, field string) error {
	return nil
}
...
func (n nopSet[V]) SAdd(ctx context.Context, val V) error {
	return nil
}

func (n nopSet[V]) SRem(ctx context.Context, val V) error {
	return nil
}
...
func (n nopZSet[V]) ZRem(ctx context.Context, member V) error {
	return nil
}

func (n NopStorage[V]) Delete(ctx context.Context, key string) error {
	return nil
}
