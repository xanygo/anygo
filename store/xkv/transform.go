...
func (t transList[V]) LPush(ctx context.Context, val V) error {
	str, err := xcodec.EncodeToString(t.codec, val)
	if err != nil {
		return err
	}
	return t.ss.LPush(ctx, str)
}

func (t transList[V]) RPush(ctx context.Context, val V) error {
	str, err := xcodec.EncodeToString(t.codec, val)
	if err != nil {
		return err
	}
	return t.ss.RPush(ctx, str)
}
...
func (t transHash[V]) HDel(ctx context.Context, field string) error {
	return t.ss.HDel(ctx, field)
}
...
func (t transSet[V]) SAdd(ctx context.Context, value V) error {
	str, err := xcodec.EncodeToString(t.codec, value)
	if err != nil {
		return err
	}
	return t.ss.SAdd(ctx, str)
}

func (t transSet[V]) SRem(ctx context.Context, val V) error {
	str, err := xcodec.EncodeToString(t.codec, val)
	if err != nil {
		return err
	}
	return t.ss.SRem(ctx, str)
}
...
func (t transZSet[V]) ZRem(ctx context.Context, member V) error {
	str, err := xcodec.EncodeToString(t.codec, member)
	if err != nil {
		return err
	}
	return t.ss.ZRem(ctx, str)
}

func (tr Transformer[V]) Delete(ctx context.Context, key string) error {
	return tr.Storage.Delete(ctx, key)
}
